...
recommendation, I started reading the famous [[https://csc-knu.github.io/sys-prog/books/Andrew%20S.%20Tanenbaum%20-%20Operating%20Systems.%20Design%20and%20Implementation.pdf][Minix Book (Operating Systems: Design and Implementation)]]. It was through this process I realised how
...
+ It was re-implemented from scratch by [[https://en.wikipedia.org/wiki/Linus_Torvalds][Linux Torvalds]] to create the Linux kernel, which now powers a vast portion of the world's servers, phones,
